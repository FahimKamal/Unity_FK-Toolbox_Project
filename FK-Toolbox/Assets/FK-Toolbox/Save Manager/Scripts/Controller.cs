...
public class Controller : MonoBehaviour
{
    ...
    {
        saveGameManager.SetInt("IntVal", mRandomInt);
        saveGameManager.SetFloat("FloatVal", mRandomFloat);
        saveGameManager.SetString("StringVal", mRandomString);
    ...
    {
        mRandomInt = saveGameManager.GetInt("IntVal", 0);
        mRandomFloat = saveGameManager.GetFloat("FloatVal", 0);
        mRandomString = saveGameManager.GetString("StringVal");
